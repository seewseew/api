...
## Pre Update Profile POS
> Request Pre Update Profile POS

```shell
curl https://api.cpone-dev.com/pre-update-profile-pos
  -X POST
  -H "Authorization: bearer {access_token}"
  -H "Content-Type: application/json"
  -d '{
...
### Request
`POST https://api.cpone-dev.com/pre-update-profile-pos`
